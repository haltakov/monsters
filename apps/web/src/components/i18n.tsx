...
const en = {
  ...
  "creator.meshExperiment": "Mesh experiment",
  "creator.classicMesh": "Classic parts",
  "creator.smoothMesh": "Smooth mesh",
  "creator.experimental": "Experimental",
...
const bg: Record<TranslationKey, string> = {
  ...
  "creator.meshExperiment": "Експеримент с мрежа",
  "creator.classicMesh": "Класически части",
  "creator.smoothMesh": "Гладка мрежа",
  "creator.experimental": "Експериментално",
...
const de: Record<TranslationKey, string> = {
  ...
  "creator.smoothMesh": "Glattes Mesh",
  "creator.experimental": "Experimentell",
