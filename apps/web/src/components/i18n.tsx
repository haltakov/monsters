...
const en = {
  ...
  "creator.meshMode": "Mesh construction mode",
  "creator.meshExperiment": "Mesh style",
  "creator.classicMesh": "Classic parts",
  "creator.smoothMesh": "Organic mesh",
  "creator.experimental": "Recommended",
  ...
  "creator.dnaHelp":
    "M5 stores all 16 genes, including mesh construction. Old M1–M4 codes still work and are upgraded automatically.",
  "creator.invalidDna": "This DNA code is invalid or incomplete.",
  "creator.footer": "16 genes · anatomy + behavior + mesh construction",
  ...
  "option.classic": "Classic parts",
  "option.smooth": "Smooth mesh",
  "option.pair": "Pair",
  "option.pack": "Pack",
...
const bg: Record<TranslationKey, string> = {
  ...
  "creator.meshMode": "Режим за изграждане на мрежата",
  "creator.meshExperiment": "Стил на модела",
  "creator.classicMesh": "Класически части",
  "creator.smoothMesh": "Органична мрежа",
  "creator.experimental": "Препоръчително",
  ...
  "creator.dnaHelp":
    "M5 пази всичките 16 гена, включително изграждането на мрежата. Старите M1–M4 кодове също работят и се обновяват автоматично.",
  "creator.invalidDna": "Този DNA код е невалиден или непълен.",
  "creator.footer": "16 гена · анатомия + поведение + изграждане на мрежата",
  ...
  "option.classic": "Класически части",
  "option.smooth": "Гладка мрежа",
  "option.pair": "Двойка",
  "option.pack": "Група",
...
const de: Record<TranslationKey, string> = {
  ...
  "creator.meshMode": "Modus für die Mesh-Konstruktion",
  "creator.meshExperiment": "Mesh-Stil",
  "creator.classicMesh": "Klassische Teile",
  "creator.smoothMesh": "Organisches Mesh",
  "creator.experimental": "Empfohlen",
  ...
  "creator.dnaHelp":
    "M5 speichert alle 16 Gene einschließlich Mesh-Konstruktion. Alte M1–M4-Codes funktionieren weiterhin und werden automatisch aktualisiert.",
  "creator.invalidDna": "Dieser DNA-Code ist ungültig oder unvollständig.",
  "creator.footer": "16 Gene · Anatomie + Verhalten + Mesh-Konstruktion",
  ...
  "option.classic": "Klassische Teile",
  "option.smooth": "Glattes Mesh",
  "option.pair": "Paar",
  "option.pack": "Gruppe",
