...
const en = {
  ...
  "language.de": "German",
  "language.en": "English",
  "meta.homeTitle": "MonstersDNA — grow a tiny wild world",
  "meta.gameTitle": "Island prototype · MonstersDNA",
  "landing.home": "MonstersDNA home",
  ...
  "creator.sectionForm": "FORM",
  "creator.sectionFace": "FACE",
  "creator.sectionSurface": "COLOR & MARKINGS",
  "creator.sectionAbilities": "ABILITIES",
  "creator.sectionInstincts": "INSTINCTS",
  "creator.behaviorGene": "Behavior gene — it changes how the monster acts.",
  "creator.noLegShape": "Add legs to choose a foot shape.",
  "creator.advanced": "Advanced DNA editor",
  "creator.advancedHint": "Paste or fine-tune a deterministic DNA code.",
  ...
  "creator.dnaHelp":
    "M6 stores all editable traits plus the smooth renderer marker. Old M1–M5 codes still work and are upgraded automatically.",
  "creator.invalidDna": "This DNA code is invalid or incomplete.",
  "creator.footer": "17 editable traits · one deterministic creature",
  ...
  "option.freckles": "Freckles",
  "option.saddle": "Saddle",
  "option.none": "None",
  "option.buds": "Buds",
  ...
  "option.crown": "Horn crown",
  "option.pointed": "Pointed",
  "option.floppy": "Floppy",
  "option.fan": "Fan ears",
  "option.long-ear": "Long ears",
  "option.tuft": "Tuft",
  "option.curly": "Curly",
  "option.club": "Club",
  "option.fin": "Tail fin",
  ...
  "game.monsterDetail": "Monster detail distance",
  "game.detailAuto": "Auto · this device",
  "game.detailPerformance": "Near · lighter load",
  "game.detailBalanced": "Far · balanced",
  "game.detailHigh": "Very far · more detail",
  "game.detailRange": "Full creatures within {{distance}} m.",
  "game.detailHelp":
    "Longer distances need more graphics power. Saved on this device.",
...
const bg: Record<TranslationKey, string> = {
  ...
  "meta.homeTitle": "MonstersDNA — отгледай малък див свят",
  "meta.gameTitle": "Островен прототип · MonstersDNA",
  "landing.home": "Начална страница на MonstersDNA",
  ...
  "creator.sectionForm": "ФОРМА",
  "creator.sectionFace": "ЛИЦЕ",
  "creator.sectionSurface": "ЦВЕТОВЕ И ШАРКИ",
  "creator.sectionAbilities": "СПОСОБНОСТИ",
  "creator.sectionInstincts": "ИНСТИНКТИ",
  "creator.behaviorGene": "Поведенчески ген — променя начина на действие.",
  "creator.noLegShape": "Добави крака, за да избереш форма на стъпалата.",
  "creator.advanced": "Разширен DNA редактор",
  "creator.advancedHint": "Постави или настрой детерминистичен DNA код.",
  ...
  "creator.dnaHelp":
    "M6 пази всички променливи черти и маркера за гладък модел. Старите M1–M5 кодове също работят и се обновяват автоматично.",
  "creator.invalidDna": "Този DNA код е невалиден или непълен.",
  "creator.footer": "17 променливи черти · едно детерминистично същество",
  ...
  "option.freckles": "Лунички",
  "option.saddle": "Седловидна шарка",
  "option.none": "Няма",
  ...
  "option.lavender": "Лавандула",
  "option.chartreuse": "Шартрьоз",
  "option.copper": "Мед",
  ...
  "game.monsterDetail": "Дистанция за детайлни чудовища",
  "game.detailAuto": "Автоматично · това устройство",
  "game.detailPerformance": "Близо · по-леко натоварване",
  "game.detailBalanced": "Далеч · балансирано",
  "game.detailHigh": "Много далеч · повече детайли",
  "game.detailRange": "Детайлни чудовища до {{distance}} м.",
  "game.detailHelp":
    "По-голямата дистанция натоварва графиката повече. Запазва се на това устройство.",
...
const de: Record<TranslationKey, string> = {
  ...
  "meta.homeTitle": "MonstersDNA — erschaffe eine kleine wilde Welt",
  "meta.gameTitle": "Insel-Prototyp · MonstersDNA",
  "landing.home": "MonstersDNA Startseite",
  ...
  "creator.sectionForm": "FORM",
  "creator.sectionFace": "GESICHT",
  "creator.sectionSurface": "FARBEN & MUSTER",
  "creator.sectionAbilities": "FÄHIGKEITEN",
  "creator.sectionInstincts": "INSTINKTE",
  "creator.behaviorGene": "Verhaltensgen — verändert, wie das Monster handelt.",
  "creator.noLegShape": "Füge Beine hinzu, um eine Fußform zu wählen.",
  "creator.advanced": "Erweiterter DNA-Editor",
  "creator.advancedHint": "Deterministischen DNA-Code einfügen oder anpassen.",
  ...
  "creator.dnaHelp":
    "M6 speichert alle editierbaren Merkmale und den Marker für das glatte Modell. Alte M1–M5-Codes funktionieren weiterhin und werden automatisch aktualisiert.",
  "creator.invalidDna": "Dieser DNA-Code ist ungültig oder unvollständig.",
  "creator.footer": "17 editierbare Merkmale · ein deterministisches Wesen",
  ...
  "option.freckles": "Sommersprossen",
  "option.saddle": "Sattelmuster",
  "option.none": "Keine",
  "option.buds": "Knospen",
  ...
  "option.orange": "Orange",
  "option.teal": "Türkis",
  "option.lavender": "Lavendel",
  "option.chartreuse": "Chartreuse",
  "option.copper": "Kupfer",
  ...
  "game.monsterDetail": "Monster-Detailreichweite",
  "game.detailAuto": "Automatisch · dieses Gerät",
  "game.detailPerformance": "Nah · weniger Last",
  "game.detailBalanced": "Weit · ausgewogen",
  "game.detailHigh": "Sehr weit · mehr Details",
  "game.detailRange": "Detaillierte Monster bis {{distance}} m.",
  "game.detailHelp":
    "Größere Reichweiten benötigen mehr Grafikleistung. Wird auf diesem Gerät gespeichert.",
...
/**
 * DNA enums are translated, while numeric genes should remain real numerals.
 * Keeping the fallback here also makes newly-added string options readable
 * during development instead of rendering an empty choice.
 */
export function getOptionLabel(locale: Locale, value: string | number) {
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<I18nContextValue>(
    () => ({
      ...
      setLocale,
      t,
      option: (optionValue) => getOptionLabel(locale, optionValue),
    }),
    [locale, setLocale, t],
  );
