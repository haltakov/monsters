    ...
    >
      ...
      <section>
        ...
        <p>
          ...
          is proxied through our website, and events are sent through our
          analytics subdomain, p.monstersdna.com. Our integration sends page
          paths, not URL query strings, monster DNA, nicknames, account IDs, or
          email addresses. Referrers are reduced to their origin, without paths
          or query strings. The script proxy removes cookies and authorization
          headers before forwarding requests to Plausible.
        </p>
        <p>
